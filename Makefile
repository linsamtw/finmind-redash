...
download-taiwan-stock-price:
	python3 upload_data2mysql.py taiwan_stock_price 2021-01-01 2020-11-02 2330 2615 2603 2609

download-taiwan-stock-institutional-investors:
	python3 upload_data2mysql.py taiwan_stock_institutional_investors 2021-01-01 2020-11-02 2330 2615 2603 2609

download-taiwan-stock-margin-purchase-short_sale:
	python3 upload_data2mysql.py taiwan_stock_margin_purchase_short_sale 2021-01-01 2020-11-02 2330 2615 2603 2609

download-taiwan-stock-holding-shares-per:
	python3 upload_data2mysql.py taiwan_stock_holding_shares_per 2021-01-01 2020-11-02 2330 2615 2603 2609
